    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="card w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-white">AI Governance Platform</h1>
        ...
        <div className="space-y-3">
          ...
          <a
            href="/auth/google"
            className="btn w-full justify-center bg-white hover:bg-gray-100 text-gray-900 focus:ring-gray-300"
          >
